...
| Anchor ID | Text | Optional HTML id for deep links such as `/contact#contact-form`. Use lowercase letters, numbers, and hyphens. |
...
- `Anchor ID` is rendered on the outer section so hash links like `/page#contact-form` scroll directly to this form block.
