...
3. Fill fields:
   ...
   - **Packages** (repeater)
     ...
     - **Pricing Tiers** (optional, WYSIWYG) — pricing options/tiers. In horizontal layout this appears in the **left** column, center-aligned.
     - **Inclusions** (optional, WYSIWYG) — what's included. In horizontal layout this appears in the **right** column, center-aligned.
