...
3. Fill in the fields:
   ...
   - **Text Align** (optional): `Left` (default), `Centre`, or `Right` — controls horizontal text alignment inside each card - **Font Size** (optional): `Small` (default), `Medium`, or `Large` — controls the font size of the service card title and description - **Services** (repeater): Click "Add Row" for each service:
