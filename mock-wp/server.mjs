...
//
// Michael would create this content through the WordPress admin UI.
...
const PAGE_CONTACT = {
  ...
  acf: {
    contact_email: 'hello@studiozanetti.com',
 ...
 * Michael can create any page in WordPress and it automatically
...
// Michael would upload each photo as a gallery_photo custom post in WP admin.
