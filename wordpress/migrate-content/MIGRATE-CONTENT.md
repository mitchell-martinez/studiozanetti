...
```bash
scp wordpress/migrate-content/migrate-content.php <user>@<SERVER_IP>:<WP_VOLUME_PATH>/migrate-content.php
```
...
```bash
ssh <user>@<SERVER_IP> rm <WP_VOLUME_PATH>/migrate-content.php
```
