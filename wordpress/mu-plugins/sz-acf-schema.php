...
add_action( 'acf/init', function () {
	...
	$text_fields = array_merge([
		...
		[ 'key' => 'field_sz_text_heading_level', 'label' => 'Semantic Heading Level', 'name' => 'heading_level', 'type' => 'select', 'choices' => [ 'h1' => 'H1', 'h2' => 'H2', 'h3' => 'H3', 'h4' => 'H4', 'h5' => 'H5', 'h6' => 'H6' ], 'default_value' => 'h2', 'instructions' => 'Controls HTML heading level for accessibility/SEO semantics only. Visual styling stays the same.' ],
	...
	$pricing_fields = array_merge([
		...
		[
			...
			'sub_fields' => [
				...
				[ 'key' => 'field_sz_pricing_package_price_qualifier', 'label' => 'Price Qualifier', 'name' => 'price_qualifier', 'type' => 'text', 'instructions' => 'Optional prefix shown before the price, e.g. "From" or "Starting at". Helps clarify that the figure is an entry point, not a fixed total — improves how search engines and AI summarise your pricing.' ],
				...
				[ 'key' => 'field_sz_pricing_package_summary', 'label' => 'Summary', 'name' => 'summary', 'type' => 'textarea', 'instructions' => 'One benefit-first sentence describing who this package suits and what makes it valuable, e.g. "Full-service premium coverage for large weddings — includes a second photographer, 10 hours and a fine-art album." Shown beside the price and used in structured data so search engines and AI cite the package in context rather than quoting the price alone.' ],
	...
	$image_block_fields = [
		...
		[ 'key' => 'field_sz_image_block_mobile_justify_text', 'label' => 'Mobile Justify Text', 'name' => 'mobile_justify_text', 'type' => 'true_false', 'ui' => 1, 'default_value' => 0, 'instructions' => 'Optional. When enabled, title/subtitle/overlay text becomes justified on mobile screens for improved readability over imagery.' ],
	...
	$form_fields = array_merge([
		[ 'key' => 'field_sz_form_form_id', 'label' => 'Form ID', 'name' => 'form_id', 'type' => 'text', 'required' => 1, 'instructions' => 'Required stable identifier used by the secure submit route. It is also used as the section anchor id for links like /page#contact-enquiry, so keep it unique on the page and do not change it after publishing.' ],
