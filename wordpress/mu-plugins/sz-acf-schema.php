...
add_action( 'acf/init', function () {
	...
	$style_fields = function ( string $prefix ): array use ( $theme_choices, $spacing_choices ) {
		return [
			[
	...
	$text_fields = array_merge([
		...
		[ 'key' => 'field_sz_text_align', 'label' => 'Align', 'name' => 'align', 'type' => 'select', 'choices' => [ 'left' => 'Left', 'center' => 'Center' ] ],
